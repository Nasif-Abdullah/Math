...
- <b>Bounds:</b> $$(\exists a,b) (\forall x \in A) \; x \le a$$ and $$(\forall x \in A) \; x \ge b$$. A poset can have multiple such elements.
...
### Posets
Posets are sets that have a relation R defined on them, and they need not to be comparable. Hasse diagrams exist to visually represent finite posets.
...
The power set of the three-element set can be written as $$P = \{\emptyset, \{x\}, \{y\}, \{z\}, \{x,y\}, \{y,z\}, \{z,x\}, \{x,y,z\}\}$$.
